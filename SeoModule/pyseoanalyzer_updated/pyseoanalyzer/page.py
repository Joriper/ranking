...
class Page:
    ...
    def __init__(
        ...
        self.url = url
        self.html_content = html_content #update
    ...
    def analyze(self, raw_html=None):
        if raw_html is None and self.html_content is not None:    #update
            raw_html = self.html_content                          #update
        """
